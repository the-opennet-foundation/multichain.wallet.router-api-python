...
modify the contents of the `src/multichain/wallet/router_api/lib/` and `examples/` directories.
...
You can release to package managers by using [the `Publish PyPI` GitHub action](https://www.github.com/the-opennet-foundation/multichain.wallet.router-api-python/actions/workflows/publish-pypi.yml). This requires a setup organization or repository secret to be set up.
