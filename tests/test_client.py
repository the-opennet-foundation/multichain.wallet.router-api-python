...
from multichain.wallet.router_api import (
    MultichainWalletRouterAPI,
    APIResponseValidationError,
    AsyncMultichainWalletRouterAPI,
)
from multichain.wallet.router_api._types import Omit
from multichain.wallet.router_api._utils import asyncify
from multichain.wallet.router_api._models import BaseModel, FinalRequestOptions
from multichain.wallet.router_api._exceptions import APIStatusError, APITimeoutError, APIResponseValidationError
from multichain.wallet.router_api._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: MultichainWalletRouterAPI | AsyncMultichainWalletRouterAPI) -> int:
...
class TestMultichainWalletRouterAPI:
    @pytest.mark.respx(base_url=base_url)
    def test_raw_response(self, respx_mock: MockRouter, client: MultichainWalletRouterAPI) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_raw_response_for_binary(self, respx_mock: MockRouter, client: MultichainWalletRouterAPI) -> None:
    ...
    def test_copy(self, client: MultichainWalletRouterAPI) -> None:
        copied = client.copy()
    ...
    def test_copy_default_options(self, client: MultichainWalletRouterAPI) -> None:
    ...
    def test_copy_signature(self, client: MultichainWalletRouterAPI) -> None:
    ...
    def test_copy_build_request(self, client: MultichainWalletRouterAPI) -> None:
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "multichain/wallet/router_api/_legacy_response.py",
                        "multichain/wallet/router_api/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "multichain/wallet/router_api/_compat.py",
    ...
    def test_request_timeout(self, client: MultichainWalletRouterAPI) -> None:
        request = client._build_request(FinalRequestOptions(method="get", url="/foo"))
    ...
    def test_default_headers_option(self) -> None:
        test_client = MultichainWalletRouterAPI(
            base_url=base_url, api_key=api_key, _strict_response_validation=True, default_headers={"X-Foo": "bar"}
        )
        ...
        test_client2 = MultichainWalletRouterAPI(
            base_url=base_url,
            api_key=api_key,
            _strict_response_validation=True,
            default_headers={
    ...
    def test_validate_headers(self) -> None:
        client = MultichainWalletRouterAPI(base_url=base_url, api_key=api_key, _strict_response_validation=True)
        request = client._build_request(FinalRequestOptions(method="get", url="/foo"))
        assert request.headers.get("Authorization") == f"Bearer {api_key}"

        with update_env(**{"MULTICHAIN_WALLET_ROUTER_API_API_KEY": Omit()}):
            client2 = MultichainWalletRouterAPI(base_url=base_url, api_key=None, _strict_response_validation=True)
    ...
    def test_request_extra_json(self, client: MultichainWalletRouterAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_request_extra_headers(self, client: MultichainWalletRouterAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_request_extra_query(self, client: MultichainWalletRouterAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_multipart_repeating_array(self, client: MultichainWalletRouterAPI) -> None:
        request = client._build_request(
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_binary_content_upload(self, respx_mock: MockRouter, client: MultichainWalletRouterAPI) -> None:
    ...
    def test_binary_content_upload_with_iterator(self) -> None:
        ...
        with MultichainWalletRouterAPI(
            base_url=base_url,
            api_key=api_key,
            _strict_response_validation=True,
    ...
    def test_binary_content_upload_with_body_is_deprecated(
        self, respx_mock: MockRouter, client: MultichainWalletRouterAPI
    ) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_basic_union_response(self, respx_mock: MockRouter, client: MultichainWalletRouterAPI) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_union_response_different_types(self, respx_mock: MockRouter, client: MultichainWalletRouterAPI) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(MULTICHAIN_WALLET_ROUTER_API_BASE_URL="http://localhost:5000/from/env"):
            client = MultichainWalletRouterAPI(api_key=api_key, _strict_response_validation=True)
    ...
    def test_base_url_trailing_slash(self, client: MultichainWalletRouterAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: MultichainWalletRouterAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: MultichainWalletRouterAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_copied_client_does_not_close_http(self) -> None:
        test_client = MultichainWalletRouterAPI(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_client_response_validation_error(self, respx_mock: MockRouter, client: MultichainWalletRouterAPI) -> None:
        class Model(BaseModel):
            foo: str
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = MultichainWalletRouterAPI(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        non_strict_client = MultichainWalletRouterAPI(
    ...
    def test_parse_retry_after_header(
        self, remaining_retries: int, retry_after: str, timeout: float, client: MultichainWalletRouterAPI
    ) -> None:
    ...
    @mock.patch("multichain.wallet.router_api._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    ...
    def test_omit_retry_count_header(
        self, client: MultichainWalletRouterAPI, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_follow_redirects(self, respx_mock: MockRouter, client: MultichainWalletRouterAPI) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_follow_redirects_disabled(self, respx_mock: MockRouter, client: MultichainWalletRouterAPI) -> None:
...
class TestAsyncMultichainWalletRouterAPI:
    @pytest.mark.respx(base_url=base_url)
    async def test_raw_response(self, respx_mock: MockRouter, async_client: AsyncMultichainWalletRouterAPI) -> None:
        respx_mock.post("/foo").mock(return_value=httpx.Response(200, json={"foo": "bar"}))
    ...
    async def test_raw_response_for_binary(
        self, respx_mock: MockRouter, async_client: AsyncMultichainWalletRouterAPI
    ) -> None:
        respx_mock.post("/foo").mock(
            return_value=httpx.Response(200, headers={"Content-Type": "application/binary"}, content='{"foo": "bar"}')
        )
    ...
    def test_copy(self, async_client: AsyncMultichainWalletRouterAPI) -> None:
    ...
    def test_copy_default_options(self, async_client: AsyncMultichainWalletRouterAPI) -> None:
        # options that have a default are overridden correctly
    ...
    async def test_copy_default_headers(self) -> None:
        client = AsyncMultichainWalletRouterAPI(
            base_url=base_url, api_key=api_key, _strict_response_validation=True, default_headers={"X-Foo": "bar"}
        )
        assert client.default_headers["X-Foo"] == "bar"
    ...
    def test_copy_signature(self, async_client: AsyncMultichainWalletRouterAPI) -> None:
        # ensure the same parameters that can be passed to the client are defined in the `.copy()` method
        init_signature = inspect.signature(
            # mypy doesn't like that we access the `__init__` property.
    ...
    @pytest.mark.skipif(sys.version_info >= (3, 10), reason="fails because of a memory leak that started from 3.12")
    def test_copy_build_request(self, async_client: AsyncMultichainWalletRouterAPI) -> None:
        options = FinalRequestOptions(method="get", url="/foo")
    ...
    async def test_request_timeout(self, async_client: AsyncMultichainWalletRouterAPI) -> None:
    ...
    async def test_default_headers_option(self) -> None:
        test_client = AsyncMultichainWalletRouterAPI(
            base_url=base_url, api_key=api_key, _strict_response_validation=True, default_headers={"X-Foo": "bar"}
        )
        request = test_client._build_request(FinalRequestOptions(method="get", url="/foo"))
        assert request.headers.get("x-foo") == "bar"
        ...
        test_client2 = AsyncMultichainWalletRouterAPI(
            base_url=base_url,
            api_key=api_key,
            _strict_response_validation=True,
            default_headers={
    ...
    def test_validate_headers(self) -> None:
        client = AsyncMultichainWalletRouterAPI(base_url=base_url, api_key=api_key, _strict_response_validation=True)
        request = client._build_request(FinalRequestOptions(method="get", url="/foo"))
        assert request.headers.get("Authorization") == f"Bearer {api_key}"

        with update_env(**{"MULTICHAIN_WALLET_ROUTER_API_API_KEY": Omit()}):
            client2 = AsyncMultichainWalletRouterAPI(base_url=base_url, api_key=None, _strict_response_validation=True)
    ...
    def test_multipart_repeating_array(self, async_client: AsyncMultichainWalletRouterAPI) -> None:
        request = async_client._build_request(
            FinalRequestOptions.construct(
                method="post",
                url="/foo",
    ...
    async def test_binary_content_upload_with_asynciterator(self) -> None:
        ...
        async with AsyncMultichainWalletRouterAPI(
            base_url=base_url,
            api_key=api_key,
            _strict_response_validation=True,
    ...
    async def test_base_url_env(self) -> None:
        with update_env(MULTICHAIN_WALLET_ROUTER_API_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncMultichainWalletRouterAPI(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    async def test_base_url_trailing_slash(self, client: AsyncMultichainWalletRouterAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    async def test_base_url_no_trailing_slash(self, client: AsyncMultichainWalletRouterAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    async def test_absolute_request_url(self, client: AsyncMultichainWalletRouterAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncMultichainWalletRouterAPI(
            base_url=base_url, api_key=api_key, _strict_response_validation=True
        )
        ...
        non_strict_client = AsyncMultichainWalletRouterAPI(
            base_url=base_url, api_key=api_key, _strict_response_validation=False
        )
    ...
    async def test_parse_retry_after_header(
        self, remaining_retries: int, retry_after: str, timeout: float, async_client: AsyncMultichainWalletRouterAPI
    ) -> None:
        headers = httpx.Headers({"retry-after": retry_after})
        options = FinalRequestOptions(method="get", url="/foo", max_retries=3)
    ...
    async def test_retries_taken(
        self,
        async_client: AsyncMultichainWalletRouterAPI,
        failures_before_success: int,
        failure_mode: Literal["status", "exception"],
        respx_mock: MockRouter,
    ) -> None:
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncMultichainWalletRouterAPI, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_follow_redirects(self, respx_mock: MockRouter, async_client: AsyncMultichainWalletRouterAPI) -> None:
        # Test that the default follow_redirects=True allows following redirects
        respx_mock.post("/redirect").mock(
            return_value=httpx.Response(302, headers={"Location": f"{base_url}/redirected"})
        )
