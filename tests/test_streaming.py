...
from multichain.wallet.router_api._streaming import Stream, AsyncStream, ServerSentEvent


@pytest.mark.asyncio
@pytest.mark.parametrize("sync", [True, False], ids=["sync", "async"])
async def test_basic(
    sync: bool, client: MultichainWalletRouterAPI, async_client: AsyncMultichainWalletRouterAPI
) -> None:
