...
class TestContract:
    ...
    def test_method_get_metadata(self, client: MultichainWalletRouterAPI) -> None:
        contract = client.evm.contract.get_metadata(
    ...
    def test_raw_response_get_metadata(self, client: MultichainWalletRouterAPI) -> None:
        response = client.evm.contract.with_raw_response.get_metadata(
            contract_address="contractAddress",
            chain_id="ethereum",
        )
    ...
    def test_streaming_response_get_metadata(self, client: MultichainWalletRouterAPI) -> None:
        with client.evm.contract.with_streaming_response.get_metadata(
            contract_address="contractAddress",
            chain_id="ethereum",
        ) as response:
    ...
    def test_path_params_get_metadata(self, client: MultichainWalletRouterAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `contract_address` but received ''"):
            client.evm.contract.with_raw_response.get_metadata(
                contract_address="",
                chain_id="ethereum",
            )
...
class TestAsyncContract:
    ...
    async def test_method_get_metadata(self, async_client: AsyncMultichainWalletRouterAPI) -> None:
        contract = await async_client.evm.contract.get_metadata(
            contract_address="contractAddress",
            chain_id="ethereum",
        )
        assert contract is None
    ...
    async def test_raw_response_get_metadata(self, async_client: AsyncMultichainWalletRouterAPI) -> None:
        response = await async_client.evm.contract.with_raw_response.get_metadata(
            contract_address="contractAddress",
            chain_id="ethereum",
        )
    ...
    async def test_streaming_response_get_metadata(self, async_client: AsyncMultichainWalletRouterAPI) -> None:
        async with async_client.evm.contract.with_streaming_response.get_metadata(
            contract_address="contractAddress",
            chain_id="ethereum",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_get_metadata(self, async_client: AsyncMultichainWalletRouterAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `contract_address` but received ''"):
            await async_client.evm.contract.with_raw_response.get_metadata(
                contract_address="",
                chain_id="ethereum",
            )
